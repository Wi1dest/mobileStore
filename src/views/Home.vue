...
<script>
    ...
    export default {
        ...
        created() {
            const _this = this
            axios.get('http://120.0.0.1:1636/goods/index').then(function (resp) {
                _this.goodsList = resp.data.data.goodsList
        ...
        methods: {
            onClick(index) {
                const _this = this
                axios.get('http://120.0.0.1:1636/goods/byCategoryType/' + this.categories[index].type).then(function (resp) {
            ...
            buy(index) {
                this.show = true
                const _this = this
                axios.get('http://120.0.0.1:1636/goods/byGoodsId/' + this.goodsList[index].id).then(function (resp) {
